<?php
	...
	class View_Form_Validator_UniqueEmail extends Tmvc_View_Form_Validator_Abstract
	{
		public $errorMessages = array
		(
			"mailTaken"		=>		"This e-mail adress is already in use by another account."
		);
		...
		public function validate($value, $context)
		{
			...
			if ( $user )
			{
				...
				{
					return $this->formatMessage("mailTaken");
				}
				else
				{
