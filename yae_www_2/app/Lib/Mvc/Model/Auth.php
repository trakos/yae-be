 ...
 */
abstract class Lib_Mvc_Model_Auth
{
	/**
	...
	/**
	 * Object instance
	 * @var Lib_Mvc_Model_Auth
	 */
	static protected $_instance=NULL;

	/**
	 * Return instance of an object.
	 * @return Lib_Mvc_Model_Auth
	 */
	...
	public function get($name)
	{
		if ( !$this->_isLogged )
		{
			throw new Lib_Mvc_Model_Auth_Exception(E_INSUFFICIENT_PRIVILEGES, "You must be logged in in order to use session data!");
		}
		else if ( !isset($this->_data[$name]))
		{
			throw new Lib_Mvc_Model_Auth_Exception(E_INSUFFICIENT_PRIVILEGES, "Session data with given name does not exist!");
		}
