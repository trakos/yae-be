...
int main()
{
	...
	/*while(1)
	{
		wstring str = ETClientListener::getInstance().getCommandW();
		if(str!=L"")
		{
			wcout << 'p' << str << 'e' << endl;
		}
